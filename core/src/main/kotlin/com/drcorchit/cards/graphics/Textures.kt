...
object Textures {
    ...
    val card3Shiny = initTexture("card_art_shiny.png")
    val signatures = initTexture("signatures_strip8.png").asSprite(8)
    val signaturesGlow = initTexture("signatures_glow_strip8.png").asSprite(8)
    val signaturesMale = initTexture("signatures2_strip8.png").asSprite(8)
