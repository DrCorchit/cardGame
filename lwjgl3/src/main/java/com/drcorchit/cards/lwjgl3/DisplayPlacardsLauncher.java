 ...
 */
public class DisplayPlacardsLauncher {
    ...
    private static Lwjgl3Application createApplication() {
        return new Lwjgl3Application(new DisplayPlacards(), getDefaultConfiguration());
    }

    public static Lwjgl3ApplicationConfiguration getDefaultConfiguration() {
        Lwjgl3ApplicationConfiguration configuration = new Lwjgl3ApplicationConfiguration();
        configuration.setTitle("DisplayPlacards");
        ...
        configuration.setWindowedMode(2642, 1761);
